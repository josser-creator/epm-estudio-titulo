...
from processors import MinutaCancelacionProcessor
...
def process_minuta_cancelacion(blob: func.InputStream) -> None:
    """
    ...
    try:
        blob_name = blob.name
        logger.info(f"Blob trigger activated for Minuta de Cancelacion: {blob_name}")
        ...
        # Procesar documento
        processor = MinutaCancelacionProcessor()
